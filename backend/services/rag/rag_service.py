...
class RAGService:
    ...
    async def ask(question: str, session_id: str):
        ...
        engine.record(
            ...
            icon="badge-check",
            fields={
                "Status": "Passed" if ContextValidatorResult.allowed else "Failed",
        ...
        engine.record(
            ...
            fields={
                ...
                "Comparison Query": QueryClassifier.is_comparison(standalone_question),
            },
        )
        ...
        engine.record(
            ...
            fields={
                "PII Sanitized": "Yes",
                "Hallucination": "Passed" if hallucination.allowed else "Failed",
            },
        )
